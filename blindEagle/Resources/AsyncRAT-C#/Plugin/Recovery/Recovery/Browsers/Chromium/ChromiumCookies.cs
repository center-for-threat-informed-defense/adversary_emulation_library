...
namespace Plugin.Browsers.Chromium
{
    public class ChromiumCookies
    {
        ...
        /* ChromiumCookies.List()
        *    About:
        *        Function loops through Chromium browser SQLite database and pulls out and decrypts cookie data 
        *    Result:
        *        Decrypted cookies from the browser
        ...
        */
        ...
        /* ChromiumCookies.Decrypt()
        *    About:
        *        Decrypts cookie data using CryptUnprotectData Windows API
        *    Result:
        *        Decrypted cookies from the browser
        *    MITRE ATT&CK Techniques:
        *        T1539 Steal Web Session Cookie
