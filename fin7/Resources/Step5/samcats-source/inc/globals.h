...
#define ATTACKKATZ				L"EVALS"
#define ATTACKKATZ_VERSION		L"1.0.0"
#define ATTACKKATZ_CODENAME		L"ATT&CK Evals Cats"
#define ATTACKKAT_MAX_WINBUILD	L"1909"
#define ATTACKKATZ_FULL			ATTACKKATZ L" " ATTACKKATZ_VERSION L" (" MIMIKATZ_ARCH L") #" ATTACKKAT_MAX_WINBUILD L" " TEXT(__DATE__) L" " TEXT(__TIME__)
#define ATTACKKATZ_SECOND			L"\"" ATTACKKATZ_CODENAME L"\""
#define ATTACKKAT_DEFAULT_LOG	ATTACKKATZ L".log"
#define MIMIKATZ_DRIVER			L"Do not user driver"
#define MIMIKATZ_KERBEROS_EXT	L"Do not use kerb functionality"
#define MIMIKATZ_SERVICE		ATTACKKATZ L"svc"
