...
namespace Plugin.Browsers.Firefox
{
    class FirefoxPassReader : IPassReader
    {
        ...
        public IEnumerable<CredentialModel> ReadPasswords()
                /*
        * FirefoxPassReader.ReadPasswords()
        *     About: 
        *          Loads firefox credentials sqlite database and retreives usernames and decrypts passwords
        *      Returns:
        *          Credential material from FireFox web browser
