...
- Pre-compiled payloads are available in the [resources](/carbanak/Resources) directory; however, they are configured to connect back to static IP address 192.168.0.4.
