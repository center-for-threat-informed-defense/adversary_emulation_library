...
#define MIMIKATZ_COMPRESSED_FILENAME	ATTACKKATZ L"_" MIMIKATZ_ARCH L".compressed"
...
NTSTATUS kuhl_m_misc_clip(int argc, wchar_t * argv[])
{
	...
	myClass.lpszClassName = ATTACKKATZ L"_Window_Message";
	kprintf(L"Monitoring ClipBoard...(CTRL+C to stop)\n\n");
	if(aClass = RegisterClassEx(&myClass))
	{
		if(kuhl_misc_clip_hWnd = CreateWindowEx(0, (LPCWSTR) aClass, ATTACKKATZ, 0, 0, 0, 0, 0, HWND_MESSAGE, NULL, hInstance, NULL))
		{
