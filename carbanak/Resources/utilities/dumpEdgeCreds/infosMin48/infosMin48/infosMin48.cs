/*
Based on SharpWeb : https://github.com/djhohnstein/SharpWeb
 */
using System;
...
namespace infosMin48
{
    public static class VaultCli
    {
        ...
        public extern static Int32 VaultGetItem(IntPtr vaultHandle, ref Guid schemaId, IntPtr pResourceElement, IntPtr pIdentityElement, IntPtr pPackageSid, IntPtr zero, Int32 arg6, ref IntPtr passwordVaultPtr);
    ...
    class Infos
    {
        public static void GetCreds()
        {
            ...
            VAULT_ITEM = typeof(VaultCli.VAULT_ITEM);
            ...
            object GetVaultElementValue(IntPtr vaultElementPtr)
            {
                ...
                switch ((int)partialElementType)
                {
                    ...
                    case 12: // VAULT_ELEMENT_TYPE == Sid
                        ...
                        break;
                    default:
                        // Several VAULT_ELEMENT_TYPES are not implemented
                        results = null;
                        break;
                }
                return results;
            ...
            // verified with - VaultCmd.exe /listschema
            ...
            for (int i = 0; i < vaultCount; i++)
            {
                ...
                if (vaultItemCount > 0)
                {
                    ...
                    for (int j = 1; j <= vaultItemCount; j++)
                    {
                        ...
                        result = VaultCli.VaultGetItem(vaultHandle, ref schemaId, pResourceElement, pIdentityElement, pPackageSid, IntPtr.Zero, 0, ref passwordVaultItem);
                        ...
                        {
                            Console.WriteLine("--- Edge Credential ---");
